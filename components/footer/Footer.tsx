  ...
  return (
    <footer className='mx-auto flex flex-col h-14 md:w-3xl items-center justify-between py-1 text-gray-400 md:flex-row md:h-10'>
      ...
      <section className='flex items-center gap-1'>
        <Link href='https://github.com/csargomez' passHref>
          <svg
        ...
        <Link href='https://www.linkedin.com/in/cgope/' passHref>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='24'
            height='24'
        ...
        <Link href='https://www.instagram.com/cgope/' passHref>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='24'
            height='24'
        ...
        <Link href='https://twitter.com/cgope' passHref>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='24'
            height='24'
